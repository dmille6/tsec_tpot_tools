...
if __name__ == "__main__":
    ...
    #tpot_query_data=es_query_obj.relativeTimeQuery("4h")
    tpot_query_data = es_query_obj.relativeTimeQuery_cache_to_disk("4h")

    # [2] consolidate by IP
    consolidate_obj = consolidate_data.consolidateTpotData(
        lookout_config, tpot_query_data
    )
